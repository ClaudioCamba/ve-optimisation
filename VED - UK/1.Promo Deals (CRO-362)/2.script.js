...
// Clean Prices - remove parsefloat above
// document.querySelector('.promo-product').scrollLeft = 600
// document.querySelector('.prod-card:nth-of-type(4) .card-price span:nth-of-type(2)').innerText = '£'+parseFloat(document.querySelector('.prod-card:nth-of-type(4) .card-price span:nth-of-type(2)').innerText.slice(1)).toFixed(2).replace(/\.0+$/,'')+'';

// document.querySelector('.pzn-prod-nav .pzn-back, .pzn-prod-nav .pzn-next').on('click', function (){
//  if (this.classList.contains('pzn-back')){
//     console.log('PZN-BACK');
//  } else if (this.classList.contains('pzn-next')){
//     console.log('PZN-NEXT');
//  }
// });
